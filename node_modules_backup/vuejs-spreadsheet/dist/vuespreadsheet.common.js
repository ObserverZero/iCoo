...
// load the styles
var content = __webpack_require__("05ee");
if(content.__esModule) content = content.default;
if(typeof content === 'string') content = [[module.i, content, '']];
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var add = __webpack_require__("499e").default
var update = add("54e1661e", content, true, {"sourceMap":false,"shadowMode":false});
...
"use strict";
/* harmony import */ var _node_modules_vue_style_loader_index_js_ref_6_oneOf_1_0_node_modules_css_loader_dist_cjs_js_ref_6_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_src_index_js_ref_6_oneOf_1_2_node_modules_postcss_loader_src_index_js_ref_6_oneOf_1_3_node_modules_cache_loader_dist_cjs_js_ref_0_0_node_modules_vue_loader_lib_index_js_vue_loader_options_VueTable_vue_vue_type_style_index_0_lang_css___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__("28ed");
/* harmony import */ var _node_modules_vue_style_loader_index_js_ref_6_oneOf_1_0_node_modules_css_loader_dist_cjs_js_ref_6_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_src_index_js_ref_6_oneOf_1_2_node_modules_postcss_loader_src_index_js_ref_6_oneOf_1_3_node_modules_cache_loader_dist_cjs_js_ref_0_0_node_modules_vue_loader_lib_index_js_vue_loader_options_VueTable_vue_vue_type_style_index_0_lang_css___WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_node_modules_vue_style_loader_index_js_ref_6_oneOf_1_0_node_modules_css_loader_dist_cjs_js_ref_6_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_src_index_js_ref_6_oneOf_1_2_node_modules_postcss_loader_src_index_js_ref_6_oneOf_1_3_node_modules_cache_loader_dist_cjs_js_ref_0_0_node_modules_vue_loader_lib_index_js_vue_loader_options_VueTable_vue_vue_type_style_index_0_lang_css___WEBPACK_IMPORTED_MODULE_0__);
...
// load the styles
var content = __webpack_require__("e9a3");
if(content.__esModule) content = content.default;
if(typeof content === 'string') content = [[module.i, content, '']];
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var add = __webpack_require__("499e").default
var update = add("0b5f5d00", content, true, {"sourceMap":false,"shadowMode":false});
...
"use strict";
/* harmony import */ var _node_modules_vue_style_loader_index_js_ref_8_oneOf_1_0_node_modules_css_loader_dist_cjs_js_ref_8_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_src_index_js_ref_8_oneOf_1_2_node_modules_postcss_loader_src_index_js_ref_8_oneOf_1_3_node_modules_sass_loader_dist_cjs_js_ref_8_oneOf_1_4_node_modules_cache_loader_dist_cjs_js_ref_0_0_node_modules_vue_loader_lib_index_js_vue_loader_options_VSelect_vue_vue_type_style_index_0_id_0a37003e_lang_scss_scoped_true___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__("5f4e");
/* harmony import */ var _node_modules_vue_style_loader_index_js_ref_8_oneOf_1_0_node_modules_css_loader_dist_cjs_js_ref_8_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_src_index_js_ref_8_oneOf_1_2_node_modules_postcss_loader_src_index_js_ref_8_oneOf_1_3_node_modules_sass_loader_dist_cjs_js_ref_8_oneOf_1_4_node_modules_cache_loader_dist_cjs_js_ref_0_0_node_modules_vue_loader_lib_index_js_vue_loader_options_VSelect_vue_vue_type_style_index_0_id_0a37003e_lang_scss_scoped_true___WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_node_modules_vue_style_loader_index_js_ref_8_oneOf_1_0_node_modules_css_loader_dist_cjs_js_ref_8_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_src_index_js_ref_8_oneOf_1_2_node_modules_postcss_loader_src_index_js_ref_8_oneOf_1_3_node_modules_sass_loader_dist_cjs_js_ref_8_oneOf_1_4_node_modules_cache_loader_dist_cjs_js_ref_0_0_node_modules_vue_loader_lib_index_js_vue_loader_options_VSelect_vue_vue_type_style_index_0_id_0a37003e_lang_scss_scoped_true___WEBPACK_IMPORTED_MODULE_0__);
/* unused harmony reexport * */
...
exports = ___CSS_LOADER_API_IMPORT___(false);
// Module
exports.push([module.i, ".glass_icon[data-v-0a37003e]{position:absolute;top:12px;right:25px;z-index:13;width:12px;height:12px;border-radius:50px;border:1px solid #1a1a1a;opacity:0;visibility:hidden;-webkit-transition:all .3s ease;transition:all .3s ease}.glass_icon[data-v-0a37003e]:after{content:\"\";display:block;position:absolute;-webkit-transform:rotate(45deg);transform:rotate(45deg);bottom:0;right:-4px;height:1px;width:5px;background:#1a1a1a}.glass_icon.show[data-v-0a37003e]{opacity:1;visibility:visible}.select_btn[data-v-0a37003e]{cursor:pointer;border:none;outline:none;background:transparent;position:absolute;z-index:10;right:8px;top:0;bottom:0}.select_icon[data-v-0a37003e]{display:inline-block;width:7px;height:7px;border-top:1px solid #1a1a1a;border-left:1px solid #1a1a1a;background:transparent;color:transparent;text-decoration:none;-webkit-transform:rotate(225deg);transform:rotate(225deg);-webkit-transition:-webkit-transform .25s ease-in-out;transition:-webkit-transform .25s ease-in-out;transition:transform .25s ease-in-out;transition:transform .25s ease-in-out,-webkit-transform .25s ease-in-out}.select_icon.active[data-v-0a37003e]{-webkit-transform:rotate(45deg);transform:rotate(45deg)}", ""]);
// Exports
module.exports = exports;
...
var copyPaste = {
  ...
  methods: {
    ...
    copyStoreData: function copyStoreData(params) {
      var value = lodashClonedeep(this.value);
      ...
      if (this.selectedMultipleCell && this.selectedCoordCells) {
        ...
        while (rowMin <= rowMax) {
          ...
          var copyData = value[rowMin][this.headerKeys[colMin]];
        ...
        var _copyData = value[this.selectedCell.row][this.selectedCell.header];
    ...
    pasteReplaceData: function pasteReplaceData() {
      var maxRow = this.value.length;
      var cell = this.value[this.selectedCell.row][this.selectedCell.header];
      ...
      if (this.storeCopyDatas[0].value && !this.copyMultipleCell && !this.selectedMultipleCell && !this.eventDrag && !this.disabledEvent(cell, this.selectedCell.header)) {
        ...
        this.value[this.selectedCell.row][this.selectedCell.header] = copiedData; // callback changeData
        ...
        while (rowMin <= rowMax) {
          ...
          if (this.eventDrag) {
            // Drag To Fill
            var duplicate = this.value[rowMin][header].duplicate;
            ...
            if (newCopyData[0][header]) {
              ...
              this.value[rowMin][header] = _newCopyData[0];
              // one cell
            ...
            if (rowColsToRowsCols) {
              ...
              if (this.selectedCoordCells.colStart === this.selectedCoordCells.colEnd) {
                ...
                this.value[rowMin][currentHeader] = _newCopyData2[0];
            ...
            if (rowsColsToRowsCols) {
              if (this.value[incrementRow][currentHeader]) {
                newCopyData[row][header].duplicate = this.value[incrementRow][currentHeader].duplicate;
              }
    ...
    modifyMultipleCell: function modifyMultipleCell(params) {
      ...
      while (rowMin <= rowMax) {
        var header = this.headerKeys[colMin];
        var cell = this.value[rowMin][header]; // disable on disabled cell
    ...
    setRectangleSelection: function setRectangleSelection(colMin, colMax, rowMin, rowMax) {
      ...
      if ((_this$$refs$ = this.$refs["".concat(this.customTable, "-vueTbody")]) !== null && _this$$refs$ !== void 0 && _this$$refs$.$refs) {
...
var handleTBody = {
  ...
  methods: {
    bindClassActiveOnTd: function bindClassActiveOnTd(header, rowIndex, colIndex) {
      ...
      this.value[rowIndex][header].active = true; // stock oldTdActive in object
    ...
    handleSearchInputSelect: function handleSearchInputSelect(event, searchValue, col, header, rowIndex, colIndex) {
      ...
      if ((!this.keys.cmd || !this.keys.ctrl) && disableSearch && ![13, 16, 17, 27, 37, 38, 39, 40, 91].includes(event.keyCode)) {
        ...
        if (event.keyCode !== 8) {
          var currentData = this.value[rowIndex][header];
    ...
    handleTbodyInputKeydown: function handleTbodyInputKeydown(event, header, rowIndex, colIndex) {
    ...
    handleTbodyTdDoubleClick: function handleTbodyTdDoubleClick(event, header, col, rowIndex, colIndex) {
      if (col.handleSearch) return; // stock oldTdShow in object
...
var moveOnTable_moveOnTable = {
  ...
  methods: {
    ...
    moveKeydown: function moveKeydown(event) {
      ...
      if (this.actualElement && this.actualElement.getAttribute("current-table") === this.customTable.toString() && [37, 39, 40, 38, 13, 27, 8].includes(event.keyCode)) {
        ...
        var currentlyEditingCell = this.value[rowIndex][header].show;
    ...
    moveOnSelect: function moveOnSelect(event) {
      ...
      if (event.keyCode === 13) {
        ...
        var currentSelect = this.value[oldSelect.rowIndex][oldSelect.header];
    ...
    handleTbodyNavBackspace: function handleTbodyNavBackspace(rowIndex, colIndex, header) {
      if (this.selectedMultipleCell) {
        ...
        var cell = this.value[rowIndex][header];
    ...
    handleTbodySelectChange: function handleTbodySelectChange(event, header, col, option, rowIndex, colIndex) {
      ...
      var value = option.value || option.item.value;
  ...
  methods: {
    ...
    rollBackUndo: function rollBackUndo() {
      if (this.storeUndoData.length) {
        var lastEdit = this.storeUndoData.pop();
        var previousValue = this.value[lastEdit.rowIndex][lastEdit.header].value;
...
// CONCATENATED MODULE: ./node_modules/cache-loader/dist/cjs.js?{"cacheDirectory":"node_modules/.cache/vue-loader","cacheIdentifier":"7b00e3f2-vue-loader-template"}!./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/cache-loader/dist/cjs.js??ref--0-0!./node_modules/vue-loader/lib??vue-loader-options!./src/components/TBody/TBody.vue?vue&type=template&id=7caf0f2e&
var TBodyvue_type_template_id_7caf0f2e_render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('tbody',[_vm._l((_vm.tbodyData),function(row,rowIndex){return [_c('tr',{key:("row" + rowIndex),staticClass:"table_row",class:{
        checked_row:
            ...
            rectangleSelection: row[header].rectangleSelection,
              ...
              row[header].comment.borderColor
                ...
                _vm.submenuTbody.find(function (sub) { return sub.disabled.includes(header) == 0; })
                        ...
                        row[header].type,
                        submenu.function
                      )}}},[_vm._v(" "+_vm._s(submenu.value)+" ")]):_vm._e()]:_vm._e()]})],2):_vm._e()]),(row[header].type === 'img')?[_c('span',[_c('img',{attrs:{"src":row[header].value,"title":row[header].value}})])]:_vm._e(),(row[header].type === 'input')?[_c('span',{ref:("span-" + _vm.currentTable + "-" + colIndex + "-" + rowIndex),refInFor:true},[_vm._v(" "+_vm._s(row[header].value)+" ")]),_c('textarea',{directives:[{name:"model",rawName:"v-model",value:(row[header].value),expression:"row[header].value"}],ref:("textarea-" + _vm.currentTable + "-" + colIndex + "-" + rowIndex),refInFor:true,domProps:{"value":(row[header].value)},on:{"keydown":function($event){return _vm.inputHandleKeydow($event, header, rowIndex, colIndex)},"change":function($event){return _vm.inputHandleChange($event, header, rowIndex, colIndex)},"keyup":function($event){if(!$event.type.indexOf('key')&&_vm._k($event.keyCode,"esc",27,$event.key,["Esc","Escape"])){ return null; }return _vm.escKeyup(row[header], rowIndex, header, colIndex, row[header].type)},"input":function($event){if($event.target.composing){ return; }_vm.$set(row[header], "value", $event.target.value)}}})]:_vm._e(),_c('v-select',{ref:("vsSelect-" + _vm.currentTable + "-" + colIndex + "-" + rowIndex),refInFor:true,attrs:{"value":row,"colIndex":colIndex,"currentTable":_vm.currentTable,"disabledEvent":_vm.disabledEvent,"filteredList":_vm.filteredList,"header":header,"rowIndex":rowIndex,"trad":_vm.trad},on:{"tbody-handle-to-open-select":_vm.tbodyOpenSelect,"tbody-handle-select-change":_vm.tbodySelectChange,"tbody-handle-search-input-select":_vm.tbodySearchInputSelect}})],2):_vm._e()]})],2)]})],2)}
var TBodyvue_type_template_id_7caf0f2e_staticRenderFns = []


// CONCATENATED MODULE: ./src/components/TBody/TBody.vue?vue&type=template&id=7caf0f2e&

// CONCATENATED MODULE: ./node_modules/cache-loader/dist/cjs.js?{"cacheDirectory":"node_modules/.cache/vue-loader","cacheIdentifier":"7b00e3f2-vue-loader-template"}!./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/cache-loader/dist/cjs.js??ref--0-0!./node_modules/vue-loader/lib??vue-loader-options!./src/components/TBody/VSelect.vue?vue&type=template&id=0a37003e&scoped=true&
var VSelectvue_type_template_id_0a37003e_scoped_true_render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return (_vm.value[_vm.header] && _vm.value[_vm.header].type === 'select')?_c('div',[_c('span',{ref:("span-" + _vm.currentTable + "-" + _vm.colIndex + "-" + _vm.rowIndex)},[_vm._v(_vm._s(_vm.value[_vm.header].value))]),(_vm.value[_vm.header].handleSearch)?[_c('i',{staticClass:"glass_icon",class:{ show: _vm.value[_vm.header].search }}),_c('button',{staticClass:"select_btn",on:{"click":function($event){$event.stopPropagation();return _vm.enableSelect($event, _vm.header, _vm.value[_vm.header], _vm.rowIndex, _vm.colIndex)}}},[_c('i',{staticClass:"select_icon",class:{ active: _vm.value[_vm.header].search === true }})]),(_vm.value[_vm.header].search === true)?_c('div',{staticClass:"dropdown"},[_c('input',{directives:[{name:"model",rawName:"v-model",value:(_vm.searchInput),expression:"searchInput"}],ref:("input-" + _vm.currentTable + "-" + _vm.colIndex + "-" + _vm.rowIndex),attrs:{"placeholder":_vm.trad[_vm.trad.lang].select.placeholder},domProps:{"value":(_vm.searchInput)},on:{"keyup":[function($event){if(!$event.type.indexOf('key')&&_vm._k($event.keyCode,"esc",27,$event.key,["Esc","Escape"])){ return null; }return _vm.escKeyup(_vm.value[_vm.header], _vm.rowIndex, _vm.header, _vm.colIndex, _vm.value[_vm.header].type)},function($event){if($event.ctrlKey||$event.shiftKey||$event.altKey||$event.metaKey){ return null; }return _vm.handleSearchInputSelect($event, _vm.value[_vm.header], _vm.header, _vm.rowIndex, _vm.colIndex)}],"input":function($event){if($event.target.composing){ return; }_vm.searchInput=$event.target.value}}}),_c('ul',{ref:("dropdown-" + _vm.currentTable + "-" + _vm.colIndex + "-" + _vm.rowIndex),class:{ show: _vm.value[_vm.header].search }},_vm._l((_vm.filteredList),function(option,index){return _c('li',{key:index,class:{ active: option.active },attrs:{"value":option.value || option.item.value},on:{"click":function($event){$event.stopPropagation();return _vm.selectHandleChange($event, _vm.header, _vm.value[_vm.header], option, _vm.rowIndex, _vm.colIndex)}}},[_vm._v(" "+_vm._s(option.label || option.item.label)+" ")])}),0)]):_vm._e()]:[_c('select',{domProps:{"value":_vm.value[_vm.header].value},on:{"change":function($event){return _vm.selectHandleChange($event, _vm.header, _vm.value[_vm.header], _vm.option, _vm.rowIndex, _vm.colIndex)}}},_vm._l((_vm.value[_vm.header].selectOptions),function(option,index){return _c('option',{key:index,domProps:{"value":option.value}},[_vm._v(" "+_vm._s(option.label)+" ")])}),0)]],2):_vm._e()}
var VSelectvue_type_template_id_0a37003e_scoped_true_staticRenderFns = []


// CONCATENATED MODULE: ./src/components/TBody/VSelect.vue?vue&type=template&id=0a37003e&scoped=true&
...
/* harmony default export */ var VSelectvue_type_script_lang_js_ = ({
  ...
  methods: {
    enableSelect: function enableSelect(event, header, cell, rowIndex, colIndex) {
      if (!this.disabledEvent(cell, header)) {
        this.searchInput = "";
        var activeOption = cell.selectOptions.find(function (opt) {
          return opt.value === cell.value;
        });
...
// EXTERNAL MODULE: ./src/components/TBody/VSelect.vue?vue&type=style&index=0&id=0a37003e&lang=scss&scoped=true&
var VSelectvue_type_style_index_0_id_0a37003e_lang_scss_scoped_true_ = __webpack_require__("dc68");
...
var VSelect_component = normalizeComponent(
  ...
  VSelectvue_type_template_id_0a37003e_scoped_true_render,
  VSelectvue_type_template_id_0a37003e_scoped_true_staticRenderFns,
  false,
  null,
  "0a37003e",
  null
...
/* harmony default export */ var TBodyvue_type_script_lang_js_ = ({
  ...
  methods: {
    ...
    autorizeOnlyNumericValue: function autorizeOnlyNumericValue(e) {
      var k = e.which;
      if (k !== 8 && k !== 13 && k !== 27 && e.key !== "0" && !Number(e.key)) return true;
      return false;
    },
    inputHandleKeydow: function inputHandleKeydow(event, header, rowIndex, colIndex) {
...
var TBody_component = normalizeComponent(
  ...
  TBodyvue_type_template_id_7caf0f2e_render,
  TBodyvue_type_template_id_7caf0f2e_staticRenderFns,
  false,
  null,
  null,
  null
...
/* harmony default export */ var VueTablevue_type_script_lang_js_ = ({
  ...
  computed: {
    ...
    filteredList: function filteredList() {
      if (this.lastSelectOpen) {
        ...
        var _ref = this.lastSelectOpen || "",
            searchValue = _ref.searchValue;

        var fuseSearch = new fuse_esm(selectOptions, this.customOptions.fuseOptions);
  ...
  methods: {
    ...
    createdCell: function createdCell() {
      ...
      this.value.forEach(function (tbody, rowIndex) {
        if (_this.customOptions.tbodyCheckbox && !tbody.vuetable_checked) {
          _this.$set(_this.value[rowIndex], "vuetable_checked", false);
        }
        ...
        _this.headerKeys.forEach(function (header) {
          if (!tbody[header]) {
            ...
            _this.$set(_this.value[rowIndex], header, data);
            ...
            _this.$set(_this.value[rowIndex], header, copyTbody);
          }

          var copy = VueTablevue_type_script_lang_js_lodashClonedeep(_this.value[rowIndex][header]);

          if (!_this.value[rowIndex][header].duplicate || _this.value[rowIndex][header].duplicate && _this.value[rowIndex][header].duplicate === copy) {
            _this.$set(_this.value[rowIndex][header], "duplicate", copy);
          }
        });
      });
    },
    ...
    enableSelect: function enableSelect(event, header, col, rowIndex, colIndex) {
      ...
      var currentElement = this.value[rowIndex][header];
    ...
    removeClass: function removeClass(params) {
      ...
      params.forEach(function (param) {
        _this3.value.forEach(function (data, index) {
          Object.keys(data).forEach(function (key) {
            if (_this3.value[index] && _this3.value[index][key] && _this3.value[index][key][param] === true) {
              _this3.$set(_this3.value[index][key], param, false);
            }
          });
    ...
    setPropertyStyleOfComment: function setPropertyStyleOfComment() {
      ...
      if ((_this$styleWrapVueTab = this.styleWrapVueTable.comment) !== null && _this$styleWrapVueTab !== void 0 && _this$styleWrapVueTab.borderColor) {
      ...
      if ((_this$styleWrapVueTab2 = this.styleWrapVueTable.comment) !== null && _this$styleWrapVueTab2 !== void 0 && _this$styleWrapVueTab2.borderSize) {
        this.$refs["".concat(this.customTable, "-vueTable")].style.setProperty("--borderCommentSize", this.styleWrapVueTable.comment.borderSize);
      }

      if ((_this$styleWrapVueTab3 = this.styleWrapVueTable.comment) !== null && _this$styleWrapVueTab3 !== void 0 && _this$styleWrapVueTab3.widthBox) {
        this.$refs["".concat(this.customTable, "-vueTable")].style.setProperty("--boxCommentWidth", this.styleWrapVueTable.comment.widthBox);
      }

      if ((_this$styleWrapVueTab4 = this.styleWrapVueTable.comment) !== null && _this$styleWrapVueTab4 !== void 0 && _this$styleWrapVueTab4.heightBox) {
...
var VueTablevue_type_style_index_0_lang_css_ = __webpack_require__("4269");
...
/******/ });
//# sourceMappingURL=vuespreadsheet.common.js.map