...
class RoomMember extends _typedEventEmitter.TypedEventEmitter {
  ...
  setMembershipEvent(event, roomState) {
    ...
    this.rawDisplayName = utils.removeDirectionOverrideChars((_event$getDirectional2 = event.getDirectionalContent().displayname) !== null && _event$getDirectional2 !== void 0 ? _event$getDirectional2 : "");
