...
class Room extends _readReceipt.ReadReceipt {
  ...
  constructor(roomId, client, myUserId, opts = {}) {
    ...
    (0, _defineProperty2.default)(this, "updateThreadRootEvents", (thread, toStartOfTimeline) => {
      if (thread.length) {
        var _this$threadsTimeline;
        this.updateThreadRootEvent((_this$threadsTimeline = this.threadsTimelineSets) === null || _this$threadsTimeline === void 0 ? void 0 : _this$threadsTimeline[0], thread, toStartOfTimeline);
        if (thread.hasCurrentUserParticipated) {
          var _this$threadsTimeline2;
          this.updateThreadRootEvent((_this$threadsTimeline2 = this.threadsTimelineSets) === null || _this$threadsTimeline2 === void 0 ? void 0 : _this$threadsTimeline2[1], thread, toStartOfTimeline);
        }
      }
    });
    (0, _defineProperty2.default)(this, "updateThreadRootEvent", (timelineSet, thread, toStartOfTimeline) => {
  ...
  createThread(threadId, rootEvent, events = [], toStartOfTimeline) {
    var _this$lastThread, _this$lastThread$root;
    if (rootEvent) {
    ...
    Object.keys(content).forEach(eventId => {
      Object.keys(content[eventId]).forEach(receiptType => {
        Object.keys(content[eventId][receiptType]).forEach(userId => {
          ...
          receiptDestination === null || receiptDestination === void 0 ? void 0 : receiptDestination.addReceiptToStructure(eventId, receiptType, userId, receipt, synthetic);
        });
      });
    });
