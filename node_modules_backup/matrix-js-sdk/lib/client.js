...
class MatrixClient extends _typedEventEmitter.TypedEventEmitter {
   ...
   */
  stopClient() {
    var _this$crypto, _this$syncApi, _this$peekSync, _this$callEventHandle, _this$groupCallEventH;
   ...
   */
  getDeviceEd25519Key() {
    var _this$crypto$getDevic, _this$crypto2;
    return (_this$crypto$getDevic = (_this$crypto2 = this.crypto) === null || _this$crypto2 === void 0 ? void 0 : _this$crypto2.getDeviceEd25519Key()) !== null && _this$crypto$getDevic !== void 0 ? _this$crypto$getDevic : null;
  }
  ...
  getDeviceCurve25519Key() {
    var _this$crypto$getDevic2, _this$crypto3;
    return (_this$crypto$getDevic2 = (_this$crypto3 = this.crypto) === null || _this$crypto3 === void 0 ? void 0 : _this$crypto3.getDeviceCurve25519Key()) !== null && _this$crypto$getDevic2 !== void 0 ? _this$crypto$getDevic2 : null;
  }
  ...
  async logout(stopClient = false) {
    var _this$crypto5, _this$crypto5$backupM;
    if ((_this$crypto5 = this.crypto) !== null && _this$crypto5 !== void 0 && (_this$crypto5$backupM = _this$crypto5.backupManager) !== null && _this$crypto5$backupM !== void 0 && _this$crypto5$backupM.getKeyBackupEnabled()) {
      try {
...
function fixNotificationCountOnDecryption(cli, event) {
  ...
  if (oldHighlight !== newHighlight || currentCount > 0) {
    ...
    const hasReadEvent = isThreadEvent ? (_room$getThread = room.getThread(event.threadRootId)) === null || _room$getThread === void 0 ? void 0 : _room$getThread.hasUserReadEvent(cli.getUserId(), event.getId()) : room.hasUserReadEvent(cli.getUserId(), event.getId());
    if (!hasReadEvent) {
      var _ref3;
